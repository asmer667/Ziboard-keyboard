...
// ============================================================
// ===  قوالب الأزرار الجديدة (بدون أيقونات - نصوص فقط)  ===
// ============================================================

val TemplateMoveEndKey = BaseKey(
    spec = "النهاية|!code/move_end",
    attributes = FunctionalAttributes
)

val TemplateArrowLeftKey = BaseKey(
    spec = "◀|!code/arrow_left",
    attributes = FunctionalAttributes
)

val TemplateSelectAllKey = BaseKey(
    spec = "تحديد|!code/select_all",
    attributes = FunctionalAttributes
)

val TemplateCopyKey = BaseKey(
    spec = "نسخ|!code/copy",
    attributes = FunctionalAttributes
)

val TemplatePasteKey = BaseKey(
    spec = "لصق|!code/paste",
    attributes = FunctionalAttributes
)

val TemplateArrowRightKey = BaseKey(
    spec = "▶|!code/arrow_right",
    attributes = FunctionalAttributes
)

val TemplateMoveHomeKey = BaseKey(
    spec = "البداية|!code/move_home",
    attributes = FunctionalAttributes
)
...
val TemplateKeys = mapOf(
    ...
    // === الأزرار الجديدة ===
    "moveEnd" to TemplateMoveEndKey,
    "arrowLeft" to TemplateArrowLeftKey,
    "selectAll" to TemplateSelectAllKey,
    "copy" to TemplateCopyKey,
    "paste" to TemplatePasteKey,
    "arrowRight" to TemplateArrowRightKey,
    "moveHome" to TemplateMoveHomeKey,
    // ======================
