...
import org.futo.inputmethod.latin.uix.settings.pages.PrivacyMenu
import org.futo.inputmethod.latin.uix.settings.pages.FontScreen
...
fun SettingsNavigator(
    ...
    CompositionLocalProvider(LocalNavController provides navController) {
        NavHost(
            ...
            composable("fonts") { FontScreen(navController) }
